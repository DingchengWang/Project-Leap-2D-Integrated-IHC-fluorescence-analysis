...
@dataclass(frozen=True)
class ZWindowPlan:
    """One fixed physical-depth Z window in zero-based inclusive coordinates."""
...
class AgeProfileDecision:
    ...
    parameter_set: str = "filename_override"
    weights: tuple[tuple[str, float], ...] = ()

@dataclass(frozen=True)
class DapiNucleus3DConfig:
    """Calibrated 3D DAPI nucleus reconstruction and structural support validation."""
