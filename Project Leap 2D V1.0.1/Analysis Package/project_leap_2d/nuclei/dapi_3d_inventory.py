...
def nucleus_slice_angular_coverage(
    boundary: np.ndarray,
    covered: np.ndarray,
    sector_count: int,
...
def evaluate_nucleus_object_3d(
    ...
    if dapi_valid:
        ...
        for z_index in np.flatnonzero(central):
            ...
            angular_coverage = nucleus_slice_angular_coverage(
                boundary,
                covered,
...
def build_dapi_object_inventory_3d(
    ...
    validation_config: DapiNucleus3DConfig | None = None,
    max_workers: int = 1,
    ...
    cfg = validation_config or DapiNucleus3DConfig()
