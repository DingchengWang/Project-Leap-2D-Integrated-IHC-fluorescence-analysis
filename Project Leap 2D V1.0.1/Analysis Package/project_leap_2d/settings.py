...
AGE_PROFILE_PARAMETER_SETS = {
    "egfp_gfap_legacy_v1": {
        "threshold": AGE_PROFILE_THRESHOLD,
        "evidence_bounds": {
            "broad_structure": (0.95, 2.20),
            "solid_structure": (0.24, 0.54),
            "limited_thin_arbor": (0.62, 0.88),
            "limited_branching": (0.14, 0.50),
            "polarized_shape": (1.70, 3.20),
            "multi_nucleus_overlap": (0.05, 0.30),
        },
        "weights": {
            "broad_structure": 0.26,
            "solid_structure": 0.20,
            "limited_thin_arbor": 0.18,
            "limited_branching": 0.16,
            "polarized_shape": 0.10,
            "multi_nucleus_overlap": 0.10,
        },
    },
    "egfp_only_p3_mature_calibration_v1": {
        "threshold": 0.38,
        "evidence_bounds": {
            "broad_structure": (0.95, 2.20),
            "solid_structure": (0.24, 0.54),
            "limited_thin_arbor": (0.35, 0.52),
            "limited_branching": (0.14, 0.50),
            "polarized_shape": (1.70, 3.20),
            "multi_nucleus_overlap": (0.05, 0.30),
        },
        "weights": {
            "broad_structure": 0.0,
            "solid_structure": 0.0,
            "limited_thin_arbor": 0.60,
            "limited_branching": 0.0,
            "polarized_shape": 0.40,
            "multi_nucleus_overlap": 0.0,
        },
    },
}
...
Z_WINDOW_TARGET_UM = 9.5

Z_SURFACE_GUARD_UM = 5.0
